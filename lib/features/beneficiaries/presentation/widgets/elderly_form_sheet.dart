...
class ElderlyFormSheet extends StatefulWidget {
  const ElderlyFormSheet({required this.cubit, this.entry, super.key});

  final ElderlyCubit cubit;
  final ElderlyEntry? entry;

  @override
  State<ElderlyFormSheet> createState() => _ElderlyFormSheetState();
}

class _ElderlyFormSheetState extends State<ElderlyFormSheet> {
      ...
      child: SingleChildScrollView(
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text(
                isEditing ? 'تعديل بيانات الشايب' : 'إضافة شايب',
